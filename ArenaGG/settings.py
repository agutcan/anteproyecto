...
# CORS: permitir que el frontend en desarrollo (Angular) acceda a la API
# Ajusta o restringe en producción según sea necesario
CORS_ALLOWED_ORIGINS = [
    'http://localhost:4200',
]

# JSON Web Tokens (Simple JWT) configuración básica
SIMPLE_JWT = {
