...
def poblar_datos(apps, schema_editor):
    ...
    # Crear usuarios
    users = [
        {"username": "player8", "password": "Usuario1", "email": "Leo@example.com"},
    {"username": "player9", "password": "Usuario1", "email": "clara@example.com"},
    {"username": "player10", "password": "Usuario1", "email": "liam@example.com"},
    {"username": "player11", "password": "Usuario1", "email": "olivia@example.com"},
    {"username": "player12", "password": "Usuario1", "email": "noah@example.com"},
    {"username": "player13", "password": "Usuario1", "email": "emma@example.com"},
    {"username": "player14", "password": "Usuario1", "email": "mason@example.com"},
    {"username": "player15", "password": "Usuario1", "email": "sophia@example.com"},
    {"username": "player16", "password": "Usuario1", "email": "james@example.com"},
    {"username": "player17", "password": "Usuario1", "email": "ava@example.com"},
    {"username": "player18", "password": "Usuario1", "email": "lucas@example.com"},
    {"username": "player19", "password": "Usuario1", "email": "mia@example.com"},
    {"username": "player20", "password": "Usuario1", "email": "benjamin@example.com"},
    {"username": "player21", "password": "Usuario1", "email": "amelia@example.com"},
    {"username": "player22", "password": "Usuario1", "email": "logan@example.com"},
    {"username": "player23", "password": "Usuario1", "email": "evelyn@example.com"},
    {"username": "player24", "password": "Usuario1", "email": "elijah@example.com"},
    {"username": "player25", "password": "Usuario1", "email": "harper@example.com"},
    {"username": "player26", "password": "Usuario1", "email": "daniel@example.com"},
    {"username": "player27", "password": "Usuario1", "email": "daniel4@example.com"},
    {"username": "player28", "password": "Usuario1", "email": "daniel2@example.com"},
    {"username": "player29", "password": "Usuario1", "email": "daniel23@example.com"},

    {"username": "match1", "password": "Usuario1", "email": "dnel23@example.com"},
    {"username": "match2", "password": "Usuario1", "email": "anie@example.com"},
    {"username": "match3", "password": "Usuario1", "email": "dani23@example.com"},
    {"username": "match4", "password": "Usuario1", "email": "daniel23@example.com"},
    {"username": "multi1", "password": "Usuario1", "email": "danel23@example.com"},
    {"username": "multi2", "password": "Usuario1", "email": "dnie2@example.com"},
    ...
    players = [
        ...
        Player(user=users[7], country='BR', games_played=75, mmr=90, games_won=40, coins=1200),
        ...
        Player(user=users[11], games_played=80, games_won=50, mmr=90, coins=1800),
        Player(user=users[12], games_played=35, games_won=20),
        Player(user=users[13], games_played=55, games_won=35, renombre=45, coins=950),
        Player(user=users[14], country='AR', games_played=65, mmr=70, games_won=45),
        ...
        Player(user=users[17], games_played=95, games_won=70, mmr=90, coins=2300),
    ...
    # Crear torneos
    tournaments = [
        Tournament(name="4 teams 2 teams inactive", game=games[1],  max_player_per_team=1, max_teams=4, start_date = timezone.now() + timedelta(minutes=3), prize_pool=1000.00, created_by=users[0]),
        Tournament(name="4 teams 4 teams inactive", game=games[1],  max_player_per_team=1, max_teams=4, start_date = timezone.now() + timedelta(minutes=3), prize_pool=1000.00, created_by=users[0]),
        Tournament(name="8 teams 4 teams inactive", game=games[1],  max_player_per_team=1, max_teams=8, start_date = timezone.now() + timedelta(minutes=3), prize_pool=1000.00, created_by=users[0]),
        Tournament(name="8 teams 8 teams inactive", game=games[1],  max_player_per_team=1, max_teams=8, start_date = timezone.now() + timedelta(minutes=3), prize_pool=1000.00, created_by=users[0]),
        Tournament(name="4 teams 4 teams inactive", game=games[1],  max_player_per_team=1, max_teams=4, start_date = timezone.now() + timedelta(minutes=3), prize_pool=1000.00, created_by=users[0]),
    ...
    tournament_teams = [
        ...
        TournamentTeam(tournament=tournaments[5], team=teams[23]),
        TournamentTeam(tournament=tournaments[6], team=teams[24]),
        TournamentTeam(tournament=tournaments[6], team=teams[25]),
    ]
    ...
    rewards = [
        ...
        Reward(name="Double XP Boost", description="Duplica tu experiencia ganada en partidas durante 24 horas.",
               coins_cost=300, stock=1, is_active=True,
        ...
        Reward(name="VIP Access", description="Accede a eventos VIP exclusivos dentro de la página.",
               coins_cost=1000, stock=20, is_active=False,
