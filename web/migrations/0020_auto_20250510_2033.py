...
def poblar_datos(apps, schema_editor):
    ...
    # Crear torneos
    tournaments = [
        Tournament(name="4 teams 2 teams inactive", game=games[1],  max_player_per_team=1, max_teams=4, start_date = timezone.now() + timedelta(minutes=5), prize_pool=1000.00, created_by=users[0]),
        Tournament(name="4 teams 4 teams inactive", game=games[1],  max_player_per_team=1, max_teams=4, start_date = timezone.now() + timedelta(minutes=5), prize_pool=1000.00, created_by=users[0]),
        Tournament(name="8 teams 4 teams inactive", game=games[1],  max_player_per_team=1, max_teams=8, start_date = timezone.now() + timedelta(minutes=5), prize_pool=1000.00, created_by=users[0]),
        Tournament(name="8 teams 8 teams inactive", game=games[1],  max_player_per_team=1, max_teams=8, start_date = timezone.now() + timedelta(minutes=5), prize_pool=1000.00, created_by=users[0]),
        Tournament(name="4 teams 4 teams inactive", game=games[1],  max_player_per_team=1, max_teams=4, start_date = timezone.now() + timedelta(minutes=5), prize_pool=1000.00, created_by=users[0]),
