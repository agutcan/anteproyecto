...
urlpatterns = [
    ...
    path('faq/', views.FaqView.as_view(), name='faqView'),  # Vista para la página de preguntas frecuentes
    ...
    path('tournament/<int:pk>/join/', views.JoinTeamListView.as_view(), name='joinTeamListView'),   # Vista para ver los torneos a los que te puedes unir
    ...
    path('tournament/create/', views.TournamentCreateView.as_view(), name='tournamentCreateView'),  # Vista para crear un torneo
    path('join_team/', views.TeamJoinView.as_view(), name='teamJoinView'),   # Vista para listar los torneos a los que te puedes unir dentro de un torneo
    ...
    path('<int:pk>/redemptions/', views.RedemptionListView.as_view(), name='redemptionListView'),  # Vista para listar todas las recompensas reclamadas
