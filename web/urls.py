...
urlpatterns = [
    ...
    path('start/tournament/<int:pk>/join/', views.JoinTeamListView.as_view(), name='joinTeamView'),
    ...
    path('start/tournament/create/<int:pk>', views.TournamentCreateView.as_view(), name='tournamentCreateView'),  # Vista los detalles de un torneo
