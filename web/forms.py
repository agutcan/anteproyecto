...
class TournamentForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if not start_date:
            ...
            self.add_error(
                "start_date",
                "La fecha de inicio debe ser al menos 1 día después de la fecha actual.",
            )
...
class PlayerForm(forms.ModelForm):
    ...
    class Meta:
        model = Player
        fields = ["first_name", "last_name", "birth_date", "country", "bio", "avatar"]
...
class SupportForm(forms.Form):
    ...
    subject = forms.CharField(
        ...
        max_length=100,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Ej: Problema con torneo..."}
        ),
    )
...
class MatchResultForm(forms.Form):
    ...
    team2_score = forms.IntegerField(min_value=0, label="Puntuación Equipo 2")
