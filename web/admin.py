...
class GameAdmin(admin.ModelAdmin):
    ...
    search_fields = ("name", "genre")  # Búsqueda por nombre del juego  # Búsqueda por género

    list_filter = ("genre",)  # Filtro por género
...
class TournamentAdmin(admin.ModelAdmin):
    ...
    list_filter = ("status", "game")  # Filtro por estado del torneo  # Filtro por juego asociado
...
class TeamAdmin(admin.ModelAdmin):
    ...
    search_fields = ("name",)  # Búsqueda solo por nombre del equipo
...
class TournamentTeamAdmin(admin.ModelAdmin):
    ...
    list_display = ("tournament", "team")  # Nombre del torneo  # Nombre del equipo
    ...
    list_filter = ("tournament",)  # Filtro por torneo
...
class MatchAdmin(admin.ModelAdmin):
    ...
    list_filter = ("status", "tournament")  # Filtro por estado del partido  # Filtro por torneo
...
class MatchResultAdmin(admin.ModelAdmin):
    ...
    list_filter = ("completed_at",)  # Filtro por fecha de finalización
...
class MatchLogAdmin(admin.ModelAdmin):
    ...
    list_filter = ("created_at",)  # Filtro por fecha de creación del registro
...
class RewardAdmin(admin.ModelAdmin):
    ...
    search_fields = ("name",)  # Búsqueda por nombre de recompensa

    list_filter = ("is_active",)  # Filtro por estado activo/inactivo
