...
class PlayerStatsListAPITest(APITestCase):
    ...
    def setUp(self):
        ...
        self.player1 = Player.objects.create(
            user=self.user1, team=self.team, mmr=60, games_played=10, games_won=7, winrate=70.0
        )
        self.player2 = Player.objects.create(
            user=self.user2, team=self.team, mmr=50, games_played=12, games_won=5, winrate=41.7
        )
...
class TournamentListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.player1 = Player.objects.create(
            first_name="Player One", user=self.user, team=self.team1, mmr=1200
        )
        self.player2 = Player.objects.create(
            first_name="Player Two", user=self.user2, team=self.team2, mmr=1100
        )
